...
describe('autonomous continuation lifecycle', () => {
  ...
  test('completed Plan Work hands its claimed ControllerRound to one already-admitted successor without reopening terminal ownership', () => {
    ...
    createWorkContract(store, {
      ...
      planSourceRevision: targetRevision, baseRevision: targetRevision, workKind: 'completed_no_change',
    ...
    createWorkContract(store, {
      ...
      planSourceRevision: targetRevision, baseRevision: targetRevision, workKind: 'repository_change', objective: 'Continue stage B.',
