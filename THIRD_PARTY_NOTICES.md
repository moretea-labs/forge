...
This inventory covers the direct runtime and development dependencies declared by `@moretea-labs/forge@1.7.1`.
...
| `react` | `19.2.8` | runtime | `MIT` | package metadata |
| `react-dom` | `19.2.8` | runtime | `MIT` | package metadata |
...
| `@types/express` | `5.0.6` | development | `MIT` | package-lock.json |
