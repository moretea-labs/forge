import type { ScheduleDecisionType, ScheduleOccurrence } from '../domain/schedule';
import {
  getOccurrence,
  getSchedule,
...
export interface ScheduledExecutionReference {
  type: string;
  repoId: string;
  jobId: string;
...
export function markScheduledExecutionRunning(controllerHome: string, job: ScheduledExecutionReference): void {
...
export function settleScheduledExecution(
  controllerHome: string,
  job: ScheduledExecutionReference,
