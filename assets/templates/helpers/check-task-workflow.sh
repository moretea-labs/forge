...
handoff_file="$(policy_get '.session.continuation_file' '.ai/harness/session/continuation.md')"
resume_file="$(policy_get '.session.resume_file' '.ai/harness/session/resume.md')"
