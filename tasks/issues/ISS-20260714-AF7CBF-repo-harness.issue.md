...
kind: "investigation"
status: "done"
updated_at: "2026-08-02T06:21:25.241Z"
source: "repo-harness-controller-v8"
---

# 完成 Repo Harness 早期稳定性修复

已完成并归档。类型、路由、检查证据、失败分类、上下文负载、工具诊断、工作流检查、重启协调和资源收敛等早期修复已合入主线。旧 restart coordinator 将由新的稳定 Bootstrap/事务发布架构替代；历史 integration_blocked 仅保留为旧执行账本证据。
...
- `commits a718911, 43b33f4, 15a44fc7, 0fd5d85d, a96b321d, 5d48975d`
- `ISS-20260802-539E7F`
- `historical cancelled Runs retained as evidence`
