...
kind: "governance"
status: "done"
updated_at: "2026-08-02T06:21:03.480Z"
source: "repo-harness-controller-v8"
---

# 完成 Matea RC6 发布

已完成并归档。Windows 修复、公开文档与 Wiki、known-good attestation、Recovery HTTPS、Cloudflare tunnel 自愈、精确 CI/Windows smoke 和 RC6 发布证据均已记录。账面 T3 仍为 running、T4 为 integration_blocked 是旧 Run/Receipt 投影残留，当前没有运行 Worker，不允许再次执行远程发布动作。
...
- `released revision 2a48486b7b8c3395d05e4f30201e968ee88f9779`
- `tag v1.4.0-rc.6`
- `ISS-20260730-6444C7`
- `historical GitHub CI/Windows smoke and Wiki synchronization evidence`
