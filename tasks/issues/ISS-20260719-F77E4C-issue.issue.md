...
kind: "feature"
status: "done"
updated_at: "2026-08-02T06:22:35.222Z"
source: "repo-harness-controller-v8"
---

# 支持可恢复的人工接管和设备交互

核心能力已经完成并归档：浏览器人工接管、持久 session、profile fencing、stale-host recovery 和可选 simulator provider 均已验证。唯一未完成的物理 iPhone provider 需求已合并到 ISS-20260720-66E25D，不再从本 Issue 调度。
...
- `ISS-20260720-66E25D merged remainder`
- `commits f7afe0e5, 7ea6f180, 03343d57`
- `historical direct-edit verification evidence`
