...
kind: "bug"
status: "planned"
updated_at: "2026-08-03T04:08:32.537Z"
source: "repo-harness-controller-v8"
---

# 确保任务只在选定仓库中执行

核心执行身份与 worktree 隔离已经完成并通过用户验收。旧 T3 对抗验证已阻塞，等待新运行时进程模型和 Work-only 执行合同后重写 fault matrix。该需求当前处于复核阶段，没有可直接调度的旧 Task。
...
- `completed commits 15f7faeb and 7d0f5d78`
- `ISS-20260802-539E7F`
- `ISS-20260802-7E1D69`
- `future target-architecture fault matrix`
