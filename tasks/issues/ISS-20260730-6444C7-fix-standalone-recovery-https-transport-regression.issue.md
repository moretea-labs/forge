...
kind: "bug"
status: "in_progress"
updated_at: "2026-07-30T02:31:58.814Z"
source: "repo-harness-controller-v8"
---

# Fix standalone Recovery HTTPS transport regression

Release-blocking bug: standalone Recovery uses Bun TLS for external HTTPS/MCP verification. The production certificate chain is valid for curl, Node and OpenSSL, but Bun and the compiled Recovery binary fail with unknown certificate verification error. The earlier Codex repair corrected 401 OAuth challenge classification and Supervisor restart behavior but did not replace or validate the failing transport.
