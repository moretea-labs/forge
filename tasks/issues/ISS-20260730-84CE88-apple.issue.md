...
updated_at: "2026-08-02T06:24:29.795Z"
source: "repo-harness-controller-v8"
---

# 让 Apple 项目配置和发布流程可持续复用

保留为 Apple 发布能力的唯一用户需求。现有 App Store Connect、Browser、Xcode、项目和设备资产盘点已完成；ContextProfile、项目绑定、签名、构建、上传、TestFlight 和发布编排仍待实现。当前阻塞于新的需求管理与运行时架构切换，切换前不执行旧任务树。
...
- `verified Apple execution asset inventory`
