...
# forge Reference: hook-operations

> **Runtime Docs**: user-level forge reference
> **Doc ID**: hook-operations
> **Version**: 1.7.1
> **Source Command**: `forge docs path hook-operations`
...
```bash
forge docs path hook-operations
forge docs show hook-operations
```
