...
# forge Reference: document-generation

> **Runtime Docs**: user-level forge reference
> **Doc ID**: document-generation
> **Version**: 1.7.2
> **Source Command**: `forge docs path document-generation`
...
```bash
forge docs path document-generation
forge docs show document-generation
```
