...
- The local CLI must satisfy the reviewed `>=0.19.3 <0.21.0` capability/help contract. Status and evidence record its resolved executable, actual version and contract fingerprint. Repo Harness never downloads tooling at action time.
