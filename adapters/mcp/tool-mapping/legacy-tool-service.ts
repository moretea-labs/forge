...
export type { CallToolResult, McpToolDefinition } from '../../../packages/protocols/mcp/tool-contract';
...
import {
  ...
  getAgentJobLog,
  listAgentJobs,
} from "../../../src/cli/agent-jobs/job-manager";
import {
...
import { integrateAgentJob, taskRunDiff } from "../../../src/cli/agent-jobs/integration";
import {
  appendTask,
  archiveIssue,
  createIssue,
...
import { buildExecutionDiagnostics, buildRequirementBoard } from '../../../src/runtime/control-plane/facade/requirement-board';
...
import { buildLocalConnectorStatusForRepo } from "../../../src/cli/local-bridge/connector-freshness";
import type {
  ControllerAgent,
  ControllerTask,
  IssueKind,
...
import { runHelper } from "../../../src/cli/runtime/helper-runner";
import {
  listSessions,
  openSession,
  readSession,
  runBrowserConsult,
  runBrowserFollowup,
} from "../../../src/cli/chatgpt-browser/engine";
import type {
  BrowserProviderName,
