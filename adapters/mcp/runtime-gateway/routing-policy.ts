...
import { isFastEligibleTool, routeExecution, type ExecutionDecision } from '../../../src/runtime/execution/thin-harness';
...
/** Pure deterministic MCP Gateway placement policy. No execution or lifecycle mutation belongs here. */
