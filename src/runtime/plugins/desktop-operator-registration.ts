...
export function createDesktopOperatorRegistrationInput(
  ...
  return {
    ...
    capabilities: [
      ...
      { capabilityId: 'desktop.interact', title: 'Desktop interaction', description: 'Press, point-click, type, send keys, and open URLs.', scopes: ['desktop.interact'], actions: ['desktop_press', 'desktop_pointer_click', 'desktop_type_text', 'desktop_key', 'desktop_open_url'] },
