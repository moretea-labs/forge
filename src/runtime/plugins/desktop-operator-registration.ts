...
function desktopOperatorActions(): AssistantPluginActionDescriptor[] {
  return [
    ...
    },
    {
      ...
      description: 'Click one previously observed Accessibility element by ref inside an observed window. Forge re-resolves the ref, rebinds it after verified application activation, derives fresh bounded geometry, captures a fresh visual revision, and fails closed on stale refs/windows; raw coordinates are never accepted.',
      readOnly: false,
      risk: 'workspace_write',
      confirmation: 'authorization',
      defaultTimeoutMs: 10_000,
