...
export function createDesktopOperatorRegistrationInput(
  ...
  return {
    ...
    capabilities: [
      ...
      { capabilityId: 'desktop.interact', title: 'Desktop interaction', description: 'Press controls, type text, send keys, and open URLs.', scopes: ['desktop.interact'], actions: ['desktop_press', 'desktop_type_text', 'desktop_key', 'desktop_open_url'] },
