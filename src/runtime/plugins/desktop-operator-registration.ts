...
export function createDesktopOperatorRegistrationInput(
  ...
  return {
    ...
    capabilities: [
      ...
      { capabilityId: 'desktop.interact', title: 'Desktop interaction', description: 'Press controls, click previously observed controls, type text, send keys, and open URLs.', scopes: ['desktop.interact', 'desktop.capture'], actions: ['desktop_press', 'desktop_select_rows', 'desktop_pointer_click', 'desktop_type_text', 'desktop_key', 'desktop_open_url'] },
