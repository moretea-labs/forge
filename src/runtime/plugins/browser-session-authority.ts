...
const authorityContextStorage = new AsyncLocalStorage<BrowserSessionAuthorityContext>();

export function withBrowserSessionAuthorityContext<T>(
  context: BrowserSessionAuthorityContext,
  operation: () => T,
): T {
  return authorityContextStorage.run(context, operation);
}

export function currentBrowserSessionAuthorityContext(): BrowserSessionAuthorityContext | undefined {
  return authorityContextStorage.getStore();
}
