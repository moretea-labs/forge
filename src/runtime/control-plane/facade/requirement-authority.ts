...
function requirementAcceptanceContext(
  ...
  // Requirement completion is model/user judgement. Plan records, Plan item
  // status and Plan acceptance never gate or determine it.
  ...
  return { requirement: current, finalizedPlanIds: [] };
}
