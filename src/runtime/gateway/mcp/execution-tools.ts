...
import { currentControllerInstanceId, startExecutionSession, type ExecutionSessionContext } from '../../control-plane/execution/session-store';
import { currentPermissionSnapshotVersion, validateWorkHandle } from '../../control-plane/execution/validation';
import { resolveAuthorizationRequest } from '../../control-plane/governance/authorization';
import { readControllerResult, searchControllerResult } from '../../evidence/result-store';
...
import { compactHandle, contractFor, identityFor, makeBoundedWorkResult, principalFor, requireSession, workForSession } from '../../control-plane/execution/work-execution-support';
import { finalizeWork } from '../../control-plane/execution/work-finalization-service';
import { bindSessionRepository, prepareWork } from '../../control-plane/execution/work-preparation-service';
...
export { releasePreparedWorkOwnership } from '../../control-plane/execution/work-execution-support';
export { selectDefaultWorkValidationChecks } from '../../control-plane/execution/work-operation-service';
export type {
